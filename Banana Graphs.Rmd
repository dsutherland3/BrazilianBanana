...
## Brazil Regional Banana Production - Initial View of Banana Dataset
...
## Brazil Regional Climate - Initial View of Climate Dataset

```{r}
ggplot(brazilCLI, aes(x = year, y = climate_Mean, color = region)) +
  geom_point() +
  labs(title = "Brazil Regional Climate",
       x = "Year",
       y = "Climate") +
  theme_minimal()
```

## Brazil Regional Banana Production (2001-2022)
...
ggplot(brazilALL, aes(year, prod, color = region)) + 
  ...
  geom_line() +
  labs(
    title = "Brazil Regional Banana Production (2001-2022)",
    x = "Year", 
    y = "Production (tons)"
  ) + 
  theme_minimal()
...
## Mean Annual Temperature by Region
...
## Aggregated Brazil Banana Production (2001-2022)
...
## Aggregated Brazil Land Banana Farmed (2001-2022)
...
## Aggregated Brazil Land Banana Farmed Per Banana Production (2001-2022)
...
## Aggregated Mean Annual Temperature
...
## Aggregated Max Annual Temperature
...
## Aggregated Min Annual Temperature
...
## Aggregated Brazil Temperature Trends (2001-2022)
...
## Aggregated Annual Temperature Range
